...
public class ExtRegistries {
    public static ResourceKey<? extends Registry<StreamCodec<ByteBuf, ? extends C2SPacket>>> C2S_MESSAGES
            = ResourceKey.createRegistryKey(ResourceLocation.parse("q-highlighter:messages/c2s"));
    public static ResourceKey<? extends Registry<StreamCodec<ByteBuf, ? extends S2CPacket>>> S2C_MESSAGES
